...
## Description
A simple modification of the original YouTube app for Wii U with the assets and some current resources, giving it a modern aesthetic of what the application is currently.
...
It is recommended to delete the original YouTube application before installing this version. Once installed, it is also recommended to restart the console to update the caches, although if it is not done, there should not be any problem anyway, Swip Swap Me saves your session, so even if you delete the original app and install the modification, when you enter you should still have your session logged in.
